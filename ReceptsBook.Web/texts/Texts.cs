    ...
    public static partial class Texts
    {
        ...
        public static class Forms
        {
            public static class Membership
            {
                ...
                {
                    public static LocalText EmailSubject = "Reset Your ReceptsBook Password";
                ...
                {
                    public static LocalText ActivateEmailSubject = "Activate Your ReceptsBook Account";
        ...
        public static class Navigation
        {
            ...
            public static LocalText SiteTitle = "ReceptsBook";
        }
